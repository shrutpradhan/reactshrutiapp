  ...
  return (
    <div className='trial'>
        <div className='form1'>
          ...
          {/* <input type="text" placeholder='Apply now'/> */}
          <button className='btn apply' style={{backgroundColor:"blue",color:"grey",fontWeight:"bold",border:"none", borderRadius:"8px",width:"200px",height:"25px"}}>Apply now</button>
          </div>
          </div>
